...
#include "stdio.h"
#include "MQTTMbed.h" //Platform specific implementation header file

#define MAX_PACKET_ID 65535
#define MAX_MESSAGE_HANDLERS 20
#define MAX_MQTT_PACKET_SIZE 2048
#define MAX_INCOMING_QOS2_MESSAGES 20
...
struct Client {
    ...
    unsigned char pubbuf[MAX_MQTT_PACKET_SIZE];
    int inflight_len;
