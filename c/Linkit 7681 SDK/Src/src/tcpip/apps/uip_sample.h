...
#define TCP_CLI_APP1_LOCAL_PORT       1234   /*The Local TCP Client Port if MT7681 as a TCP client */
#define TCP_CLI_APP1_REMOTE_PORT    9999   /*The Remote TCP Server Port in the WAN/LAN */
#define TCP_CLI_APP1_IOT_SRV_IP        {192,168,43,58}  /*The Remote TCP Server IP Address in the WAN/LAN */
