...
{
    // printf_high("running this is main ");
 ...
 {
//	 printf_high("SUBTASK Running");
counter++;
if(counter%20 == 19)
{
	printf_high("Main is called");
	ThisIsNotmain();
}
...
void IoT_Cust_SM_Smnt(void)
{
    ...
    uint8  Ssid[MAX_LEN_OF_SSID+1] = "ALTIZON-02";
    uint8  Passphase[CIPHER_TEXT_LEN] ="AltizonWirelesS" ;
